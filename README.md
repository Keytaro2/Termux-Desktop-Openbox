...
```bash
apt update && apt upgrade -y && apt install git wget x11-repo -y && git clone https://github.com/Keytaro2/Termux-Desktop-Openbox.git && cd Termux-Desktop-Openbox && python3 install.py && ./startopenbox_termux.sh
```
